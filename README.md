...
- **What the lineage cascade delivers that nobody bound** (OQ 51, ruled 25 Aug, refusal half built 28 Aug, first adjudication pass 2 Sep): 273 role gaps, 232 of them never judged, 129 judged. Ruled adjudicate-first — but the backlog **refills as it is worked**, because declining a pack re-attributes the role to the next ancestor: one log node needs 26 declines over 9 rounds to reach fixpoint, so 245 is what is visible rather than what is required.
