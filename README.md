...
| `mcp_server/` | **The MCP server — 23 tools.** This is the real answer to "navigable for AI": not a file format, a server. See `mcp_server/README.md`. |
