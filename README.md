...
**Why this exists:** [`VISION.md`](VISION.md) — the pattern-book line this resumes, from Vignola to Asher Benjamin, and why the next one has to be executable.
**Where it stands:** [`STATE-OF-THE-PROJECT.md`](STATE-OF-THE-PROJECT.md). **What is next:** [`PLAN-OF-ACTION.md`](PLAN-OF-ACTION.md).
