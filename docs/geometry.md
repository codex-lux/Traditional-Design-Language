...
Measured on `plans/tidewater-georgian-careful.json`, `auto`: **serious 79 → 56, stacks kept 0 → 3 of 5, no room drawn outside its own band** (the worst had been a 13 × 16 ft bedroom drawn 45 × 7), and the passage 22 × 19 → 9 × 40, spanning again. The cost is on the other shipped plan: `spec-builder-colonial` proves in 29.6 s against a 25 s budget and falls back to the search — `oq/a-shipped-plan-needs-thirty-seconds-and-the-budget-is-twenty-five`.
