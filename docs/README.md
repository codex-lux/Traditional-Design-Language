...
| 4 | Grammar — proportion packs | [`proportion.md`](proportion.md) | 40 packs as functions not tables; Vignola spine, authority overlays as deltas; module normalisation. |
