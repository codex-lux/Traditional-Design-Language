...
**118 questions, of which 44 are open.** A question is OPEN while
...
| **oq/a-grouping-rule-and-a-room-record-can-disagree** | OPEN | [six instances, one of them on fourteen partis, and nothing checks the class](open-questions/oq-a-grouping-rule-and-a-room-record-can-disagree.md) |
...
| **oq/a-slug-in-a-code-span-is-not-checked** | OPEN | [the citation guard cannot see two thirds of the namespace it guards, and removing the exemption would convict fourteen honest illustrations](open-questions/oq-a-slug-in-a-code-span-is-not-checked.md) |
...
| **oq/the-parti-dissolved-its-own-dependencies** | OPEN | [a Georgian main block asked to hold a service program the type put in outbuildings](open-questions/oq-the-parti-dissolved-its-own-dependencies.md) |
