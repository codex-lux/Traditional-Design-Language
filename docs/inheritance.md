...
package started; `inherited_packs` is **3,056** and `judged` **249**, and `unendorsed` has moved
from 249 to **215**. That is well over a hundred judgments for a headline movement of seventeen,
