...
change. The corpus now carries **168 declines** and **41 endorsed** gaps, against 10 and 38 when the
package started; `inherited_packs` is **3,198** and `judged` **209**, and `unendorsed` has moved
from 249 to **225**. That is well over a hundred judgments for a headline movement of seventeen,
