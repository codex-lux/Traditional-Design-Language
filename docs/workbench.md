...
served, measured 24 Sep 2026 after WP-14.3 added the glossary's words; it was ~206 KB before)
...
not name; `test_search_index.py` runs all 762 through the server's own validator.
