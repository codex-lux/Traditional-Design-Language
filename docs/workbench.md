...
**Search.** `GET /api/search/index` serves every nameable thing once (839 entries, ~258 KB
...
not name; `test_search_index.py` runs all 839 through the server's own validator.
