...
**Search.** `GET /api/search/index` serves every nameable thing once (845 entries, ~258 KB
...
not name; `test_search_index.py` runs all 845 through the server's own validator.
