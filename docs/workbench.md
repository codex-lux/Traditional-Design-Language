...
**Search.** `GET /api/search/index` serves every nameable thing once (822 entries, ~258 KB
...
not name; `test_search_index.py` runs all 822 through the server's own validator.
