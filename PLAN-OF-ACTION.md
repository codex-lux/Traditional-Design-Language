...
| **7 — The three open questions** | WP-7.1, 7.2, 7.3 | **Complete (27 Aug 2026)** — OQ 76, 73 and 72, each ruled by Lucas and each half-closed with the half that could not be done named. The generator is level-aware and fixed BEARING not stacking (transfer beams 166 → 109); furniture sizing is REFUSED and arrangement goes as far as the rooms' own words; a window's ROLE is the plan's to decide and its SASH KIND the style's, with 119 of 159 styles answering through the lineage |
