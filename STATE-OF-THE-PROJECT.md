...
751 derived rules, **26 checks and 750 tests across 27 files** (was 22 and 419 across 22).
...
| Governance | `docs/open-questions.md` | **53 entries, 8 open** | six network-blocked; **OQ 52 and 53 need a ruling** — both raised 25 Aug by an adversarial audit of this session |
...
| Checks | `build/*.py` | **26 checkers** | All pass; incl. `check_counts`, `check_addresses`, `check_inheritance` |
| Checks | `tests/` | **750 tests, 27 files** | All pass; one run, ~8 min; no CI |
