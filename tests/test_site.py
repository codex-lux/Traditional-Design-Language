...
class TestGeometrySolverHonoursLotWidth:
    ...
    def test_unchanged_when_plan_has_no_site_data(self, geometry_module):
        ...
        # 7 AT THE MERGE OF THE TWO PHASE 11s (8 Sep 2026): this branch 8, main 5, merged 7,
        # measured on `git archive` checkouts of both parents and deterministic on repeat.
