...
def test_the_inheritance_backlog_is_pinned_and_cannot_grow_silently():
    ...
    assert ci.RATCHET == {"role_gaps": 283, "inherited_packs": 3341, "unendorsed": 245}
...
def test_unendorsed_is_the_number_the_ruling_moves_and_endorsed_is_not_a_fault():
    ...
    ci = _check_inheritance_module()
    assert endorsed_printed == 38, "38 of the 283 gaps are endorsed by the pack's own applies_to"
