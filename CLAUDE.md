...
322 image records, 0 sourced · 14 reference plans · 24 MCP tools · **31 checks, 842 tests** (plus 11 in the workbench app suite, `node --test`).
...
- **Open questions are live**, and this line was stale for a day, which is worth knowing before
  ...
  (7, 8, 9, 10, 11, 18, 36, 37, 38, 39, 40, 41, 64, 65, 66). **Ids 32-41 mean something
