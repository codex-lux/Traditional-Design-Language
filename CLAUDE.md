...
four sheets, and every red is a placement row or the shared flue. **WHAT THE PROVER SAYS ABOUT
...
- **Open questions are live**, and this line was stale for a day, which is worth knowing before
  ...
  run `build/gen_open_questions.py`. It holds **196 entries, of which 104 are open**
