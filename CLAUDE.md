...
reads the JavaScript and holds all three against each other. Do not add a fourth copy.** Search is `⌘K` over `/api/search/index` (814 named things,
...
- **Open questions are live**, and this line was stale for a day, which is worth knowing before
  ...
  run `build/gen_open_questions.py`. It holds **224 entries, of which 127 are open**
