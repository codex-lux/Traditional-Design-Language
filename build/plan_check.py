        ...
        for it in rt.get("furniture", []):
            ...
            if w + 1e-6 < need_short:
                F.add("serious", "furniture",
                      ...
                      # THE EVIDENCE CONTRACT (WP-9.1). The figure a move needs, UNROUNDED --
                      ...
                      # never moved and the finding could never clear.
                      kind="furniture-fit", need_ft=round(need_short, 3), have_ft=w, axis="width",
                      item=it["item"], sides=sides, clearance_in=cl, footprint_in=[fw, fl])
                ...
                F.add("minor", "furniture",
                      ...
                      kind="furniture-fit", need_ft=round(need_long, 3), have_ft=l, axis="length", item=it["item"])
